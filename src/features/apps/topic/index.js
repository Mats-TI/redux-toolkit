...
const TopicApp = () => {
	...
	return (
		<Grid pos="relative" mt="1px" height="100%">
			<Flex gap={2}>
				<Box
					boxShadow="2xl"
					bg="white"
				...
				>
					{currentTopic && currentTopic.length ? (
						<TopicDetail currentTopic={currentTopic} />
					) : (
								...
								<TabPanels>
									<TabPanel>
										...
										<Card
											...
											className="slim-card p-0 mt-2 m-0"
										>
											<Row className="p-0">
									...
									<TabPanel>
										...
										>
											<Row className="p-0">
												<Col span={24} className="pl-2">
													<Title level={5}>
														good <PopoverList icon={<EditOutlined />} />
													</Title>
													<div className="details small text-muted">
